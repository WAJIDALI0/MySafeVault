  ...
  return (
    <div className="bg-[#0b1120] border border-slate-800 rounded-xl p-6 h-full flex flex-col">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/settings/security" className="text-sm text-slate-400 hover:text-white transition-colors">View all</Link>
      </div>

      <div className="space-y-4 flex-1">
        
        {/* Recommendation 1 */}
        <Link href="/settings/security" className="block group flex items-start gap-4 p-3 -mx-3 rounded-lg hover:bg-slate-800/30 transition-colors cursor-pointer outline-none focus:bg-slate-800/30">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-slate-200 group-hover:text-white transition-colors">Great! Your 2FA is enabled</p>
        ...
        {/* Recommendation 2 */}
        <Link href="/vault" className="block group flex items-start gap-4 p-3 -mx-3 rounded-lg hover:bg-slate-800/30 transition-colors cursor-pointer outline-none focus:bg-slate-800/30">
          <div className="w-8 h-8 rounded-full bg-[#f59e0b]/10 flex items-center justify-center text-[#f59e0b] flex-shrink-0 mt-0.5">
            <AlertTriangle className="w-4 h-4" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-[#f59e0b] group-hover:text-[#fbbf24] transition-colors">You have 3 weak passwords</p>
        ...
        {/* Recommendation 3 */}
        <Link href="/settings/account" className="block group flex items-start gap-4 p-3 -mx-3 rounded-lg hover:bg-slate-800/30 transition-colors cursor-pointer outline-none focus:bg-slate-800/30">
          <div className="w-8 h-8 rounded-full bg-[#3b82f6]/10 flex items-center justify-center text-[#3b82f6] flex-shrink-0 mt-0.5">
            <Info className="w-4 h-4" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-slate-200 group-hover:text-white transition-colors">Backup your vault</p>
